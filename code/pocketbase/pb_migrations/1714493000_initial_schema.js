  ...
  const collections = [
    ...
    },
    {
      ...
      "schema": [
        ...
        { "id": "field_b_status", "name": "status", "type": "text", "system": false, "required": true, "presentable": false, "unique": false, "options": { "min": null, "max": null, "pattern": "" } },
        { "id": "field_b_total_shares", "name": "total_shares", "type": "number", "system": false, "required": false, "presentable": false, "unique": false, "options": { "min": null, "max": null, "noDecimal": true } },
